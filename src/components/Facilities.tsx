...
/**
 * واجهة الخصائص لمكون المصانع والعمليات.
 */
...
/**
 * مكون المصانع والعمليات (Facilities & Operations Component).
 * يعرض تفاصيل المنشآت الصناعية في مصر وليبيا مع بروتوكولات ضبط الجودة والتصنيع.
 */
export default function Facilities({ t, isRtl }: FacilitiesProps) {
  return (
    <section className="py-24 bg-black relative overflow-hidden" id="facilities">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-1 gap-12 items-center">
          ...
          >
            {t.facilities.paragraphs.map((p: string, i: number) => (
